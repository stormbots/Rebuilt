...
package frc.robot.Subsystems.Climber.ClimberElevator;
...
public class ClimberElevator extends SubsystemBase {
  ...
  ClimberElevatorSim sim = new ClimberElevatorSim(motor);
  ...
  public ClimberElevator() {
    ...
    var conversionfactor=1; //1 divided by whatever number you determined
		config.encoder
