...
public class CustomColor {
  ...
  public static final CustomColor kPanamáBlue = new CustomColor(13, 68, 168);
  public static final CustomColor kPanamáRed = new CustomColor(218, 18, 26);
  ...
  public static final CustomColor kMéxicoGreen = new CustomColor(0, 99, 65);
  public static final CustomColor kMéxicoBrown = new CustomColor(117, 49, 0);
  public static final CustomColor kMéxicoRed = new CustomColor(200, 16, 46);
  public static final CustomColor kCubaBlue = new CustomColor(0, 75, 135);
  public static final CustomColor kRepúblicaDominicanaBlue = new CustomColor(0, 45, 98);
  public static final CustomColor kRepúblicaDominicanaRed = new CustomColor(206, 17, 38);
  public static final CustomColor kRepúblicaDominicanaGreen = new CustomColor(0, 99, 0);
  public static final CustomColor kJamaicaGreen = new CustomColor(0, 155, 58);
  public static final CustomColor kHaitíBlue = new CustomColor(0, 32, 159);
  public static final CustomColor kHaitíRed = new CustomColor(210, 16, 52);
  ...
  public static final CustomColor kCanadáRed = new CustomColor(216, 6, 33);
