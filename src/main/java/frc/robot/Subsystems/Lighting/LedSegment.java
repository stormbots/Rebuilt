...
public class LedSegment extends LedBase {
    ...
    */
    public Command seguimosAquí(){
      double duration = 2.5;
      LedMultiRange chile = new LedMultiRange(new LedRange(CustomColor.kChileBlue),new LedRange(CustomColor.kWhite,15,3), new LedRange(CustomColor.kChileBlue),new LedRange(CustomColor.kWhite,3,2),new LedRange(CustomColor.kBoliviaGreen));
      LedMultiRange argentina = new LedMultiRange(new LedRange(CustomColor.kArgentinaBlue),new LedRange(CustomColor.kWhite,12,5), new LedRange(CustomColor.kArgentinaYellow),new LedRange(CustomColor.kWhite,12,7),new LedRange(CustomColor.kArgentinaBlue));
      LedMultiRange uruguay = new LedMultiRange(new LedRange(CustomColor.kWhite,60.0/9,1),new LedRange(CustomColor.kUruguayYellow), new LedRange(CustomColor.kWhite,60.0/9,5),new LedRange(CustomColor.kBlue),new LedRange(CustomColor.kWhite,60.0/9,7),new LedRange(CustomColor.kBlue),new LedRange(CustomColor.kWhite,60.0/9,9));
      LedMultiRange paraguay = new LedMultiRange(new LedRange(CustomColor.kRed),new LedRange(CustomColor.kWhite,12,5), new LedRange(CustomColor.kParaguayGreen),new LedRange(CustomColor.kWhite,60,28),new LedRange(CustomColor.kUruguayYellow),new LedRange(CustomColor.kWhite,60,33),new LedRange(CustomColor.kParaguayGreen),new LedRange(CustomColor.kWhite,12,7),new LedRange(CustomColor.kRed));
      ...
      LedMultiRange honduras = new LedMultiRange(new LedRange(CustomColor.kHondurasBlue),new LedRange(CustomColor.kWhite,15,6), new LedRange(CustomColor.kHondurasBlue),new LedRange(CustomColor.kWhite,20,29.0/3),new LedRange(CustomColor.kHondurasBlue),new LedRange(CustomColor.kWhite,15,10),new LedRange(CustomColor.kHondurasBlue));
      ...
      LedMultiRange cuba = new LedMultiRange(new LedRange(CustomColor.kCubaBlue),new LedRange(CustomColor.kWhite,7.5,2), new LedRange(CustomColor.kCubaBlue),new LedRange(CustomColor.kBoliviaRed,10,29.0/6),new LedRange(CustomColor.kWhite),new LedRange(CustomColor.kBoliviaRed,10,37.0/6), new LedRange(CustomColor.kCubaBlue),new LedRange(CustomColor.kWhite,7.5,44.0/8) ,new LedRange(CustomColor.kCubaBlue));
      ...
      LedMultiRange haití = new LedMultiRange(new LedRange(CustomColor.kHaitíBlue),new LedRange(CustomColor.kWhite,7.5,4.25), new LedRange(CustomColor.kHaitíBlue));
      ...
      LedMultiRange puertoRico = new LedMultiRange(new LedRange(CustomColor.kPuertoRicoRed),new LedRange(CustomColor.kWhite,7.5,2), new LedRange(CustomColor.kPuertoRicoRed),new LedRange(CustomColor.kPuertoRicoBlue,10,29.0/6),new LedRange(CustomColor.kWhite),new LedRange(CustomColor.kPuertoRicoBlue,10,37.0/6), new LedRange(CustomColor.kPuertoRicoRed),new LedRange(CustomColor.kWhite,7.5,44.0/8) ,new LedRange(CustomColor.kPuertoRicoRed));
