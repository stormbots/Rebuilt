...
public class LedSegment extends LedBase {
    ...
    */
    public Command seguimosAqui(){
      ...
      LedMultiRange costaRica = new LedMultiRange(new LedRange(CustomColor.kCostaRicaBlue),new LedRange(CustomColor.kWhite,10,2), new LedRange(CustomColor.kGuyanaRed),new LedRange(CustomColor.kWhite,10,7),new LedRange(CustomColor.kCostaRicaBlue));
